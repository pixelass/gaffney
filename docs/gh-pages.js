...
var CONFIGURATION = exports.CONFIGURATION = '__CONFIGURATION__';
var ATTRIBUTES = exports.ATTRIBUTES = '__ATTRIBUTES__';
var PROCESSOR = exports.PROCESSOR = '__PROCESSOR__';
var PRE_PROCESSOR = exports.PRE_PROCESSOR = '__PRE_PROCESSOR__';
var CREATE_COMPONENT = exports.CREATE_COMPONENT = '__CREATE__COMPONENT__';
var GET_NAME = exports.GET_NAME = '__GET_NAME__';
var CREATE_SELECTOR = exports.CREATE_SELECTOR = '__CREATE__SELECTOR__';
...
var _stylesheets = __webpack_require__(41);
...
var _gaffney = __webpack_require__(47);
...
_core2.default.use(_react4.default);

var gaffney = new _gaffney2.default();

var YEAR = (0, _date.getFullYear)();
var MONTH = (0, _date.getMonth)();
var DATE = (0, _date.getDate)();
var DAY = (0, _date.getDay)();
var PHASE = gaffney.trig2(YEAR, MONTH, DATE);
var FIRST_DAY = (0, _date.getDay)(YEAR, MONTH, 1);
var SVG_WIDTH = 700;
var SVG_HEIGHT = 600;

var Wrapper = _core2.default.div(_templateObject);

var Calendar = function Calendar(props) {
  return _react2.default.createElement('svg', _extends({ viewBox: '-20 -20 ' + (SVG_WIDTH + 40) + ' ' + (SVG_HEIGHT + 40)
  }, props));
};
...
var A = _core2.default.a(_templateObject2);

var Day = function Day(props) {
  return _react2.default.createElement(
    A,
    { href: props.href },
    _react2.default.createElement('circle', _defineProperty({ key: 'active',
      r: SVG_HEIGHT / 24,
      cx: SVG_WIDTH / 14,
      cy: SVG_HEIGHT / 24 + SVG_HEIGHT / 100,
      fill: 'none',
      strokeWidth: SVG_HEIGHT / 300,
      stroke: props.today ? 'var(--gaffney-calendar-today-stroke, #00f)' : props.selected ? 'var(--gaffney-calendar-selected-stroke, #000)' : 'none'
    }, 'fill', props.today ? 'var(--gaffney-calendar-today-fill, none)' : props.selected ? 'var(--gaffney-calendar-selected-fill, none)' : 'var(--gaffney-calendar-background, #fff)')),
    _react2.default.createElement(
      'text',
      { x: props.x || SVG_WIDTH / 14,
...
var Moon = function Moon(_ref) {
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      'g',
      { transform: transform },
      _react2.default.createElement('circle', { cx: size / 2,
        cy: size / 2,
        r: size / 2,
        fill: 'var(--gaffney-svg-moon-fill-1, #555)' }),
      _react2.default.createElement('path', { d: (0, _svg.crescentShape)({ size: size, progress: phase }).d,
        fill: 'var(--gaffney-svg-moon-fill-2, #ddd)' })
    )
  );
};

var th = function th(n) {
...
var App = function (_Component) {
  ...
  function App() {
    ...
    _this.stateFromHash = _this.stateFromHash.bind(_this);
    return _this;
  }

  _createClass(App, [{
    key: 'stateFromHash',
    value: function stateFromHash(e) {
      var selected = parseInt(e.newURL.split('/').reverse()[0].split('-')[2], 10);
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            Day,
            { fontSize: SVG_HEIGHT / 20,
              x: SVG_WIDTH / 2 },
            _date.months.long[MONTH],
            ' ',
            th(DATE),
            ' ',
            YEAR
          ),
          _date.days.short.map(function (d, i) {
            return _react2.default.createElement(
              'svg',
              { key: i,
                x: SVG_WIDTH / 7 * i,
          ...
          [].concat(_toConsumableArray(new Array(42).fill().map(function (x, i) {
              ...
              function () {
                ...
                return [_react2.default.createElement(
                  ...
                  { key: 'day',
                    ...
                    href: '#!/' + YEAR + '-' + MONTH + '-' + d,
                    today: d === DATE,
                    selected: d === _this2.state.selected },
                  d
                ), _react2.default.createElement(Moon, { key: 'moon',
          ...
          [].concat(_toConsumableArray(new Array(5).fill().map(function (x, i) {
            return i + 1;
          }))).map(function (y) {
            return _react2.default.createElement('line', { key: 'line-y_' + y,
              x1: '',
              x2: SVG_WIDTH,
              y1: SVG_HEIGHT / 6 * y,
              y2: SVG_HEIGHT / 6 * y,
          ...
          [].concat(_toConsumableArray(new Array(6).fill().map(function (x, i) {
            return i + 1;
          }))).map(function (x) {
            return _react2.default.createElement('line', { key: 'line-x_' + x,
              x1: SVG_WIDTH / 7 * x,
              x2: SVG_WIDTH / 7 * x,
              y1: SVG_HEIGHT / 12,
              y2: SVG_HEIGHT,
...
*/
var aa=__webpack_require__(3),l=__webpack_require__(12),B=__webpack_require__(4),C=__webpack_require__(1),ba=__webpack_require__(13),da=__webpack_require__(14),ea=__webpack_require__(15),fa=__webpack_require__(16),ia=__webpack_require__(17),D=__webpack_require__(5);
...
var _getInvalidAttributes = __webpack_require__(36);
...
exports.default = ['a', 'abbr', 'address', 'area', 'article', 'aside', 'audio', 'b', 'base', 'bdi', 'bdo', 'big', 'blockquote', 'br', 'button', 'canvas', 'caption', 'cite', 'code', 'col', 'colgroup', 'data', 'datalist', 'dd', 'del', 'details', 'dfn', 'div', 'dl', 'dt', 'em', 'embed', 'fieldset', 'figcaption', 'figure', 'footer', 'form', 'h1', 'h2', 'h3', 'h4', 'h5', 'h6', 'header', 'hgroup', 'hr', 'html', 'i', 'iframe', 'img', 'input', 'ins', 'kbd', 'keygen', 'label', 'legend', 'li', 'link', 'main', 'map', 'mark', 'marquee', 'meta', 'meter', 'nav', 'noscript', 'object', 'ol', 'optgroup', 'option', 'output', 'p', 'param', 'picture', 'pre', 'progress', 'q', 'rp', 'rt', 'ruby', 's', 'samp', 'script', 'section', 'select', 'small', 'source', 'span', 'strong', 'style', 'sub', 'summary', 'sup', 'table', 'tbody', 'td', 'textarea', 'tfoot', 'th', 'thead', 'time', 'title', 'tr', 'track', 'u', 'ul', 'video', 'wbr', 'circle', 'clipPath', 'defs', 'ellipse', 'g', 'image', 'line', 'linearGradient', 'mask', 'path', 'pattern', 'polygon', 'polyline', 'radialGradient', 'rect', 'stop', 'svg', 'text', 'tspan'];
...
var _hashCode = __webpack_require__(39);
...
var _getInvalidAttributes = __webpack_require__(44);
...
var _minify = __webpack_require__(43);
...
var _domElements = __webpack_require__(45);
...
var _trig2 = __webpack_require__(48);
...
var _julianDay = __webpack_require__(50);
...
exports.setAttributeNS = exports.crescentShape = exports.svgElement = exports.svgString = undefined;
...
var crescentShape = function crescentShape(_ref) {
  ...
  var sH = size / 2;
  var sQ = size / 4;
  var p = (sQ + progress / defaultRadius * sH) % sH;
  var r2 = p * 2;
  var r = (0, _utils.abs)(sH - r2);
  ...
  // prettier-ignore
  var d = ['M', sH, 0, 'A', r2 < sQ * 3 ? r - sQ : sQ - r, sQ, 0, 1, (0, _utils.floor)(r2 / sQ) % 2, sH, size, sQ, sQ, 0, 1, 1 - (0, _utils.floor)(r2 / sH), sH, 0].join(' ');
...
var getFullYear = function getFullYear() {
  return date.apply(undefined, arguments).getFullYear();
};
...
var getMonday = function getMonday() {
  var today = new Date();
  var day = getDay();
  var diff = getDate() - day + (day == 0 ? -6 : 1);
